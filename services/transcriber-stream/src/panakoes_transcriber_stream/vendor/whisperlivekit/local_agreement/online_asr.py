...
# Upstream path: whisperlivekit/local_agreement/online_asr.py
#
# MODIFIED (Panakoes vendor lift, see vendor/README.md):
#   7. Rewrote the timed_objects import to a package-relative form so this
#      file resolves under the vendored subtree without requiring upstream's
#      top-level ``whisperlivekit`` namespace on sys.path. No algorithmic
#      changes to the LocalAgreement-2 inner loop.
import logging
import sys
