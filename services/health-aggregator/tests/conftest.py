"""Shared pytest fixtures for the health-aggregator service."""
...
def _seed_jwt_env(monkeypatch: pytest.MonkeyPatch) -> Iterator[None]:
    ...
    monkeypatch.setenv("JWT_AUDIENCE", "health-aggregator")
    from panakoes_health_aggregator.auth import get_validator
