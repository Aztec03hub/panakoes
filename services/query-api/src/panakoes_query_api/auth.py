...
Implementation parity with `services/ingestion-api/auth.py` is
deliberate: shared verification surface across services makes a
future extraction into a shared `panakoes-auth` library trivial.
"""
